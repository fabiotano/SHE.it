      ...
      >
        ...
        {products.map((product, index) => (
          <SwiperSlide key={index}>
            <div className="relative w-[210px] h-[300px] my-5 bg-white border rounded-md m-auto hover:bg-gray-200 group transform transition-transform duration-300 hover:-translate-y-2">
              {/* FAV */}
              {product.newFlag && (
